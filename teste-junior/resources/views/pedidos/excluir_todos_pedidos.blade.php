...
<body>      
    <h1>Todos os Pedidos Exclusão</h1>
    <h2>Selecione o pedido que deseja excluir!</h2>
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
    ...
    @foreach ($pedidos as $pedido)
        <div class="pedido-item">
            ...
            <input type="checkbox" class="selecionar-pedido" data-id="{{ $pedido->id_pedido }}">
            <a href="{{ route('excluir_pedido', ['id_pedido' => $pedido->id_pedido]) }}">
    ...
    <script src="{{ asset('assets/js/pedidos/excluir_todos_pedidos.js') }}"></script>
</body>
</html>
