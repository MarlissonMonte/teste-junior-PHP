function searchData() {
    ...
    // Obtém todos os elementos com a classe 'pedido-item'
    var pedidos = document.getElementsByClassName('pedido-item');

    // Itera sobre os pedidos e verifica se o termo de pesquisa está presente no número do pedido, quantidade, status ou data/hora
    for (var i = 0; i < pedidos.length; i++) {
        ...
        var dataHoraPedido = pedido.getElementsByTagName('p')[3].innerText.toLowerCase();

        // Verifica se o termo de pesquisa está presente no número do pedido, quantidade, status ou data/hora
